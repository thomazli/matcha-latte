# VR but Dark
Modern VR games are almost entirely built on game controller inputs, button/vibration feedback, and are addicted to conveying all information visually. What if we subverted all of that?## The Vision
